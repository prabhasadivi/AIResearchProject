...
@description: This script analyzes stock data from Netflix and creates a support-vector regressional model of it.
...
def graph(x, y):
    ...
    plt.ylabel('Stock (NFLX) Open Price')
    plt.title('Support Vector Regression on NFLX Open Prices')
