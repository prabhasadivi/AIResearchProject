...
@description: This script analyzes stock data from Apple and creates a support-vector regressional model of it.
...
def graph(x, y):
    ...
    plt.title('Support Vector Regression on AAPL Open Prices')
