...
@description: This script analyzes stock data from Microsoft and creates a neural network model of it.
...
def graph(x, y):
    ...
    plt.title('Deep Neural Network Analysis on MSFT Open Prices')
