...
@description: This script analyzes stock data from Netflix and creates a neural network model of it.
...
def graph(x, y):
    ...
    plt.title('Deep Neural Network Analysis on NFLX Open Prices')
